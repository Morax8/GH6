...
export default function explorePage() {
  ...
  return (
    <div className="grid grid-cols-12 gap-5 place-content-start bg-white min-h-screen overflow-hidden relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-white to-transparent -top-180 opacity-50 z-0">
        <Image
      ...
      <div className="relative flex flex-col justify-center items-center col-span-12 gap-8 font-semibold h-screen px-32">
        <div className="text-5xl text-black z-2">Categories</div>

        <div className="relative h-65 w-full">
          <button
            className="absolute z-100 -left-5 top-[40%] btn btn-soft btn-warning rounded-full bg-black text-white text-xl  focus:border-none"
          ...
          <button
            className="absolute z-100 -right-5  top-[40%] btn btn-soft btn-warning rounded-full bg-black text-white text-xl focus:border-none"
            onClick={() => handleScroll(1)}
          >
            &gt;
          </button>
            ...
            {categories.map((category, i) => (
              ...
              >
                ...
                <div className="absolute bottom-4 left-5 flex flex-col gap-1">
                  ...
                  <div className="text-sm font-medium">282 items</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="col-span-12 h-screen grid grid-cols-12 relative">
        <div className="col-span-12 w-screen h-96 mb-12 absolute z-1">
      ...
      <div className="h-screen px-32 col-span-12 flex flex-col justify-center items-start gap-20 relative z-100">
        ...
        <div className="grid grid-cols-12 gap-5 w-full">
          {provinces.map((province, i) => (
            <div
              key={i}
              className="col-span-2 h-46 bg-neutral-400 relative w-full"
            >
